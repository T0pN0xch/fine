...
/// Lists every expense for [member] within the Insights screen's currently
/// selected timeframe (week/month/year/custom).
class MemberTransactionsScreen extends ConsumerWidget {
  final Member member;
  const MemberTransactionsScreen({super.key, required this.member});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final timeframe = ref.watch(insightsTimeframeProvider);
    final txnsAsync =
        ref.watch(insightsMemberTransactionsProvider(member.id));
